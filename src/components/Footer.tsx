        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Há mais de 75 anos formando pessoas que transformam o mundo
              através do inglês. A tradição e qualidade da Cultura Inglesa agora
              em Teresina.
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-primary-600 hover:bg-primary-700 text-white px-4 py-3 rounded-lg font-semibold transition-colors duration-200"
              >
