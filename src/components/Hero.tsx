      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <WhatsAppButton
                ...
                variant="inline"
                className="border-2 border-white text-white bg-transparent hover:bg-green-600 hover:text-primary-700"
            ...
            <div className="pt-6 border-t border-blue-400">
              <p className="text-blue-200 text-sm">
                ...
                condições especiais até o final do ano.
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            {/* Floating cards */}
            <div className="absolute -top-4 -left-4 bg-white text-primary-700 p-4 rounded-xl shadow-lg z-20">
              <div className="text-2xl font-bold">75+</div>
              <div className="text-sm">Anos de tradição</div>
            </div>

            <div className="absolute -bottom-4 -right-4 bg-accent-500 text-white p-4 rounded-xl shadow-lg z-20">
