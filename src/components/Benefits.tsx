...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Todos os nossos professores possuem certificação pela Cambridge English e preparamos você para os exames internacionais reconhecidos em mais de 150 países.",
